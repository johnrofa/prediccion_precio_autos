...
def addUser():
    ...
    regRF11 = joblib.load(os.path.dirname(__name__) +'prediccion_precio_autos/phishing_clf_01.pkl')
    leMake= joblib.load(os.path.dirname(__name__) + 'prediccion_precio_autos/leMake_01.pkl')
    leModel= joblib.load(os.path.dirname(__name__) + 'prediccion_precio_autos/leModel_01.pkl')
    leState= joblib.load(os.path.dirname(__name__) + 'prediccion_precio_autos/leState_01.pkl')
